...
class HashCode_v1
{
    ...
    {
        File file=new File("C:\\Z_Sarthak\\Personal\\Google HashCode\\HashCode\\InOutFiles\\e.txt");
        ...
        F>=1 && F<=1000)
        {
            ...
            File outputfile=new File("C:\\Z_Sarthak\\Personal\\Google HashCode\\HashCode\\InOutFiles1\\outputf.txt");
            BufferedWriter out = new BufferedWriter(new FileWriter(outputfile));

            int num_intersection=cities.get(car_idx).size()-1;
